...
background_image = pygame.transform.scale(pygame.image.load("pygame/download.png"), (SCREEN_WIDTH, SCREEN_HEIGHT))

# load font once at the beginning
font = pygame.font.SysFont("Times New Roman", FONT_SIZE, True)
...
sprite2 = Sprite(pygame.color.Color("red"), 20, 30)
